...
int main(int argc, char **argv)
{
    ...
    while (iter<itermax && erreur < erreur_schwartz){
        ...
        if (me==0){
            ...
            RHS0 = second_membre(beta,gamma,coeff_Robin,X,Y0,tk,stencil_up,stencil_down,me, taille_recouvrement,1); //Y0 definie dans une boucle if (à resoudre) et ajout de la boucle du temps
        ...
        else if (me==np-1)
        {
            ...
            RHSnp = second_membre(beta,gamma,coeff_Robin,X,Ynp,tk,stencil_up,stencil_down,me, taille_recouvrement,1); //Ynp definie dans une boucle if (à resoudre) et ajout de la boucle du temps
            ...
            RHSme = second_membre(beta,gamma,coeff_Robin,X,Ynp,tk,stencil_up,stencil_down,me, taille_recouvrement,1); //idem
